...
> **Reference for**: `[SUBAGENT 1A]` through `[SUBAGENT 1G]`

---

## Objective

Identify 10-15 macro investment trend chains across **TWO TIME HORIZONS**:
...
**For each trend**:
- Assess timing maturity and remaining runway
- Avoid trend-following into late-stage dynamics unless clear undervalued nodes exist
- Map catalysts to second-, third-, fourth-order effects
- Prioritize chains where Canada has structural advantage
