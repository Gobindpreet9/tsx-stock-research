...
> **Reference for**: `[SUBAGENT 3-{TICKER}]`

---

## Objective

For each candidate, run independent buy/pass analysis. **Launch ALL stock analyses simultaneously**.
...
- Revenue breakdown
- Competitive moat (pricing power, switching costs, network effects, regulatory barriers, IP)
- Management quality (founder-led? insider ownership? capital allocation?)
- Pure-play vs. conglomerate (<20% trend exposure = conglomerate)

---

### B. Financial Health (Score 1-10)

- Revenue growth (3-year CAGR, recent quarter)
- Profitability (gross/operating/FCF margins)
- Balance sheet (net debt/EBITDA, current ratio, cash runway)
- ROIC vs. WACC
...
- Current P/E, P/S, EV/EBITDA vs. 5-year average
- Relative vs. peers
- PEG if growth
- Trend priced in?
- DCF/sum-of-parts if applicable
...
- Position in chain (early/mid/late node)?
- Catalysts next 6-12 months?
- Management commentary from earnings calls

---

## CRITICAL: Late-Cycle Assessment
...
- TFSA/FHSA/RRSP eligibility
- Withholding tax if U.S.-listed
- CAD/USD exposure
- TSX liquidity (volume, spread)
- SEDI insider activity
...
- Correlation to other portfolio stocks
- **REQUIRED**: One strong bear case (search for "why {TICKER} is overvalued")
...
Apply all critical thinking protocols from `references/02_framework_principles.md`:
...
**Bias Check**: REQUIRED: One strong bear case. Search for "why {TICKER} is overvalued."
